...
function validateDomain() {
    const domain =
        document.getElementById("domain").value; const pre =
            "ckpcet.com";
    const token2 =
        domain.includes(pre); if (token2 !==
            true) {
        isValid = true;
        return "Wrong domain and u sholud write like ckpcet.com\n";
    }
}
